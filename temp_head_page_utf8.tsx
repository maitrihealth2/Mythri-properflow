...
const INPUT_PLACEHOLDERS: Record<string, string> = {
  ...
  'hi-IN': "αñàαñ¬αñ¿αÑÇ αñ¡αñ╛αñ╡αñ¿αñ╛αñôαñé αñòαñ╛ αñ╡αñ░αÑìαñúαñ¿ αñòαñ░αÑçαñé...",
  'te-IN': "α░«α▒Ç α░¡α░╛α░╡α░╛α░▓α░¿α▒ü α░╡α░┐α░╡α░░α░┐α░éα░Üα░éα░íα░┐...",
  'ta-IN': "α«ëα«Öα»ìα«òα«│α»ì α«ëα«úα«░α»ìα«╡α»üα«òα«│α»ê α«╡α«┐α«╡α«░α«┐α«òα»ìα«òα«╡α»üα««α»ì..."
}
...
export default function ConsultationPage() {
  ...
  const handleTextSend = async (text?: string) => {
    ...
    try {
      ...
      // Exercise overlay ΓÇö show when exercise is suggested or in progress
  ...
  return (
    <div className="relative flex flex-col min-h-[100dvh] w-full">
      ...
      {/* Floating Composer ΓÇö fixed, no strip wrapper */}
